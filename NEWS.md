...
-  Added a new vignette which provides an example of how to evaluate visually and quantitatively a single nowcast model specification, as well as how to use quantitative evaluation metrics to choose a model specification.
