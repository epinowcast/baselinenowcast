...
```
The below figure depicts the low-level function workflow, depicting options for estimating delays and uncertainty from other reporting triangles. ![](./man/figures/function_workflow.png)
See the ["Get Started" vignette](https://baselinenowcast.epinowcast.org/articles/baselinenowcast.html) for a full example of a typical user workflow estimating the delay distribution and uncertainty from a single reporting triangle.
