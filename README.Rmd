...
```
The below figure depicts the low-level function workflow, depicting options for estimating delays and uncertainty from other reporting triangles. ![](./man/figures/function_flow.png)
