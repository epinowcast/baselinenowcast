...
- [`apply_reporting_structure()`](https://baselinenowcast.epinowcast.org/reference/apply_reporting_structure.md)
  : Apply reporting structure to generate a single retrospective
  reporting triangle
...
- [`germany_covid19_hosp`](https://baselinenowcast.epinowcast.org/reference/germany_covid19_hosp.md)
  **\[deprecated\]** : Incident COVID-19 hospitalisations indexed by the
  date of positive test (reference date) and report date from Germany in
  2021 and 2022.
