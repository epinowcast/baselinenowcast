...
- reporting_triangle_matrix:
  ...
  Matrix of reporting triangle where rows are reference times, columns
  are delays, and entries are incident counts.

- reference_dates:

  Vector of Date objects indicating the reference dates corresponding to
