test_that("Basic functionality with valid input", {
  ...
  result <- nowcast_list_to_df(nowcast_list)
...
test_that("Input validation works correctly", {
  ...
  expect_error(nowcast_list_to_df(invalid_list))

  # Empty list
  expect_error(nowcast_list_to_df(list()))
})
...
test_that("Single matrix handling", {
  ...
  result <- nowcast_list_to_df(list(single_mat))
