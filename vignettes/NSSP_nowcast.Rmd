...
<strong>Warning:</strong> This dataset does not represent data from real patients, it is entirely simulated.
</div>
...
NSSP_time_stamps_long <-
  NSSP_time_stamps_long |>
  mutate(time_stamp = time_stamp = as.POSIXct(
      str_remove_all(
