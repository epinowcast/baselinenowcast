...
```{r}
message("Number of reference times used for delay estimation: ", n_history_delay)
message("Number of reference times used as retrospective nowcast times for uncertainty estimation: ", n_retrospective_nowcasts)
```
