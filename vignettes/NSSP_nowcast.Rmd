...
In this case study, we will use synthetic data from the United States' [National Syndromic Surveillance](https://www.cdc.gov/nssp/index.html) (NSSP) dataset to nowcasts cases of Broad Acute Respiratory Incidence (ARI).
