---
title: "Nowcasting U.S. National Syndromic Surveillance Program (NSSP) data"
...
In this vignette, we will show an example of how to clean and pre-process line-list patient-level data from the [National Syndromic Surveillance](https://www.cdc.gov/nssp/index.html) (NSSP) dataset.
The NSSP Emergency Department (ED) visit dataset is a datset widely used by public health departments in the United States, representing many but not all counties in the country.
This dataset is entirely fake, it represents a small number of synthetic records that mirror the NSSP update fields.
