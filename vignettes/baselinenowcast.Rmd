...
#> Error in estimate_uncertainty(pt_nowcast_matrices = retro_pt_nowcast_mat_list, : unused arguments (pt_nowcast_matrices = retro_pt_nowcast_mat_list, trunc_reporting_triangles = trunc_rep_tri_list, reporting_triangles = retro_rep_tri_list)
```
...
#> Error: object 'disp_params' not found

head(nowcast_draws_df)
#> Error: object 'nowcast_draws_df' not found
```
...
#> Error: object 'obs_with_nowcast_draws_df' not found
```
