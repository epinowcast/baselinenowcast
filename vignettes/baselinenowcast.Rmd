...
```{r}
trunc_rep_tri_list <- truncate_to_rows(reporting_triangle,
...
See the documentation for `truncate_to_rows()` and `construct_triangles()` for more information on the inputs and outputs of these functions.
