...
observed_long <- data_long[location == "DE"][age_group == "00+"] |> # nolint
  enw_filter_report_dates(latest_date = nowcast_date) |>
  enw_filter_reference_dates(include_days = n_history_delay + n_history_uncertainty - 1) # nolint
head(observed_long)
...
final_data <- data_long[location == "DE"][age_group == "00+"] |> # nolint
  ...
  enw_filter_reference_dates(
    ...
    include_days = n_history_delay + n_history_uncertainty - 1
  ) |>
  group_by(reference_date) |>
  summarise(
