...
As an example, let's start by just generating a single draw of the predicted
nowcast vector. We'll first have to just extract from the point nowcast matrix
the values that were predicted
```{r}
...
pred_nowcast_vector_draw <- get_nowcast_pred_draw(
