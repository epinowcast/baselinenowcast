...
We can join both datasets to the probabilistc nowcasts by the reference date.
...
<!-- Note, the below is from the summary in nssp_nowcast, so we could make this a code chunk like installation to avoid duplication -->

In this vignette we use the package's default settings to specify the model, but the optima settings will depend on the context and its important to tune the model for your dataset and needs.
