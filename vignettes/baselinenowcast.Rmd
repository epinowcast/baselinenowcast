...
We will use 3 times the maximum delay for the total training volume, with the
most recent 50% of the reference times used for delay estimation.
...
```
Prepare the final data, `target_data` so we can combine the datasets.
