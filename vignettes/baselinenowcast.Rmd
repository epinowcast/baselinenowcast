...
```{r, plot-data, height = 5, width = 9, class.source = "fold-hide"}
...
```{r specify-delay-estimate-training-volume}
...
```{r make-heatmap-reporting-triangle, height = 9, width = 9, class.source = "fold-hide"}
...
```
```{r plot-delay, height = 18, width = 9, class.source = "fold-hide"}
delay_df <- data.frame(
...
```{r, height = 5, width = 9, class.source = "fold-hide"}
...
```
```{r plot-probablistic-nowcasts, height = 5, width = 9, class.source = "fold-hide"}
