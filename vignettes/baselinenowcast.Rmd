...
```{r, plot-data, out.width = '100%', class.source = "fold-hide"}
...
```{r make-heatmap-reporting-triangle, out.width = '100%', class.source = "fold-hide"}
...
```
```{r plot-delay, out.width = '100%', class.source = "fold-hide"}
delay_df <- data.frame(
...
```
```{r plot-probablistic-nowcasts, out.width = '100%', class.source = "fold-hide"}
