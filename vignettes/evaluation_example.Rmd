...
```{r}
p_all_dates <- plot_multiple_nowcasts(data = mult_nowcasts_to_plot,
                                      eval_data_full = eval_data_full)
p_anim <- p_all_dates +
...
mult_nowcasts_ms <- pmap_dfr(
  ...
  \(nowcast_date, prop_delay, scale_factor) {
    run_single_nowcast(nowcast_date, prop_delay, scale_factor,
      data = syn_nssp_df,
      max_delay = max_delay
    ) |>
      mutate(
