...
The generation of a point nowcast is described in the schematic below \@ref(fig:pt-nowcast), describing how the missing elements of the reporting triangle are estimated and can then be used to generate a point estimate of the final counts at each reference time.
