...
By assuming that $z \sim Bin(x_t, \delta)$ and $x_t \sim Unif(0, \inf)$, it has been shown that the expected value of $x_t$, the total number of reported cases on reference time $t$, can be written as:
