...
We note that this method is equivalent to the so-called chain ladder method @Friedland2010, adapted to our notation in terms of reporting triangles (rather than *development triangles* as used in accounting). The intuition behind the method is described below in Figure @fig-squares, where the basic assumption is that the ratio between the delays in the complete observations (navy and purple elements of the matrix) is equivalent to the ratio between the delays in the partially observed components of the matrix (blue and pink elements of the matrix).

```{r squares}
#| echo = FALSE,
#| fig.cap = '*Figure 1.* Visual description of the iterative “completing” of the reporting
#|  triangle, which relies on the assumption that the ratio between delays for
#|  fully observed reference times is consistent with the ratio between those
#|  same delays in the partially observed data.'
...
```{r pt_nowcast}
#| echo = FALSE,
#| fig.cap = '*Figure 2.* Visual description of the generation of a point
#|     nowcast matrix from a reporting triangle and delay PMF. '
...
#| echo = FALSE,
#| fig.cap = '*Figure 3.* Visual description of the uncertainty quantification method,
#|    which generates retrospective point nowcasts and compares those estimates
#|    to what was later observed as of the nowcast time.'
...
#| echo = FALSE,
#| fig.cap = '*Figure 4.* Visual description of the generation of predicted probabilistic
...
#|    predicted components at each reference time.'
knitr::include_graphics(file.path(
  "..", "man", "figures",
...
```{r comb_w_obs}
#| echo = FALSE,
#| fig.cap = '*Figure 5.* Visual description of combining the observations
#|  with the probabilistic predicted nowcast components to generate
