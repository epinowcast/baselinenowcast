...
This is described in the schematic Figure \@ref(fig:predicted_prob_nowcasts) which describes sampling from the observation model with a mean given by the sum of the predicted components in the point nowcast matrix (the shaded squares).
