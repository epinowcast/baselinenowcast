...
This vignette walks through and produces the exact same results as in the [Getting Started](baselinenowcast.html) vignette, which uses the package default settings to specify the model.
