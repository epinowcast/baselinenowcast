...
The line-list data contains a single row for each patient, and columns for the diagnosis code (`DischargeDiagnosisUpdates`) and a the time stamp of that encounter with the electronic health record (`DischargeDiagnosisMDTUpdates`).
