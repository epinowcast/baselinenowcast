...
```{r}
data("syn_nssp_line_list", package = "baselinenowcast")
syn_nssp_line_list
```
...
```{r}
data("syn_nssp_df", package = "baselinenowcast")
syn_nssp_df
```
<div class="alert alert-warning" role="alert">
...
As a final pre-processing step, we'll convert to a reporting_triangle object.
```{r}
reference_dates <- rep_tri_df$reference_date

rep_tri_mat <- rep_tri_df |>
