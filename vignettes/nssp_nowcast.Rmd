...
We use a vectorized approach by combining all diagnosis codes into a single regural expression pattern, which is much faster than row-by-row iteration for large datasets.
```{r}
