...
We now create a reporting triangle object from the data using `as_reporting_triangle()`, which converts the data from long format to the matrix representation needed for nowcasting.
```{r}
